...
// microCMS returns category as array for select fields
interface CMSNews extends Omit<News, "category"> {
  category: string[];
}

function normalizeNews(raw: CMSNews): News {
  return {
    ...raw,
    category: (Array.isArray(raw.category) ? raw.category[0] : raw.category) as NewsCategory,
  };
}
...
export async function getNewsList(params?: {
  ...
  const data = await client.getList<CMSNews>({
    endpoint: "news",
    queries: {
...
export async function getNewsDetail(slug: string): Promise<News | null> {
  ...
  return raw ? normalizeNews(raw) : null;
}
...
const dummyArtists: Artist[] = [
  {
    ...
    Twitter: "https://x.com/andouyuudesu",
  ...
  },
  {
    ...
    Twitter: "https://twitter.com/ok_yoro",
    TikTok: "https://www.tiktok.com/@ok_yoro",
    sortOrder: 2,
  },
  {
    id: "3",
  ...
  },
  {
    ...
    Twitter: "https://x.com/ideahady",
    TikTok: "https://www.tiktok.com/@hady971123",
    sortOrder: 4,
  },
];
